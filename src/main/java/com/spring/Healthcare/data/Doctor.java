...
//
//    public Doctor(String firstName, String lastName, String email, String password, String phoneNumber,
//                 String specialization, String licenseNumber, Double consultationFee) {
//        super(null, firstName, lastName , email, password, phoneNumber, UserRole.DOCTOR);
